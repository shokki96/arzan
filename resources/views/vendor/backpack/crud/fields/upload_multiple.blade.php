...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <div class="well well-sm file-preview-container">
    	@foreach($field['value'] as $key => $file_path)
    		<div class="file-preview m-b-5">
                <img src="{{asset('uploads/'.$file_path)}}" class="img-thumbnail img-lg">
	    		<a class="p-t-10" target="_blank" href="{{asset('uploads/'.$file_path)}}">{{ $file_path }}</a>
